...
- **Fully dynamic** — no hardcoded layout data. Systems (power connections), roster, turnouts, sensors and signal masts are discovered live from the JMRI server (`GET /json/power`, `{"list": ...}`).
